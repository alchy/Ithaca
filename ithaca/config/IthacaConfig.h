...
// NOTE: Sample bank paths are now configured via samplebank_config.json
// in the user's roaming profile directory. This file is generated by CMake
// during build and installed to the appropriate platform-specific location:
...
// Hardcoded paths have been removed to support flexible installation directories.
...
// NOTE: DEFAULT_SAMPLE_DIR has been removed - use SampleBankPathManager instead
